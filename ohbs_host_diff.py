#!/usr/bin/env python3
"""ohbs-host drift detection, remediation verification and waiver hygiene.

Pure logic layer — no CLI parsing, no subprocess, no I/O beyond what the
caller supplies. Consumed by ohbs_cli.py (CLI wiring) and exercised directly
...
<p style="color:#94a3b8; font-size:12px; margin-top:32px;">Generated {generated} · ohbs-host</p>
</body>
</html>"""
