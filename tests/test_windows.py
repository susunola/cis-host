...
WINDOWS_ENGINES = [
    os.path.join(ROOT, "cis-win2016-ansible/roles/cis_win2016/files/cis_engine.ps1"),
    os.path.join(ROOT, "cis-win2019-ansible/roles/cis_win2019/files/cis_engine.ps1"),
    os.path.join(ROOT, "cis-win2022-ansible/roles/cis_win2022/files/cis_engine.ps1"),
    os.path.join(ROOT, "cis-win2025-ansible/roles/cis_win2025/files/cis_engine.ps1"),
]
