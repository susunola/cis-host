...
If you discover a security vulnerability in cis-bulwark (e.g., a rule that introduces a misconfiguration, an insecure default, or a privilege escalation path), please report it responsibly.
