# CIS Red Hat Enterprise Linux 10 Ansible Playbook

Automated CIS Benchmark assessment for Red Hat Enterprise Linux 10.
...
- `roles/ohbs-rhel10/` — Role with engine + rules

## Engine

Powered by the shared Python 3 CIS engine.
The catalog (`rules.json`) contains CIS Red Hat Enterprise Linux 10 Benchmark v1.0.1 rules.
