...
รายงานแสดงผลลัพธ์ของการประเมินปัจจุบัน หากการ apply ทำให้เกิดข้อผิดพลาดใหม่ในการตรวจสอบซ้ำ รายงานจะแสดงในบล็อก "regressions"
...
รายงาน HTML สองรูปแบบที่แตกต่างกันถูกสร้างขึ้นจากการทำงานทุกครั้ง ทั้งสองเป็นไฟล์แบบสแตติก ครบในตัว พร้อมพิมพ์ และทำงานแบบออฟไลน์ได้เต็มรูปแบบ ใช้ Jinja2 + vanilla JS ร่วมกัน และไม่โหลดทรัพยากรจากภายนอก
...
- **ตัวกรอง** — ตามสถานะ (pass / fail / manual / error / n/a), กลุ่ม, ระดับ, ส่วน
- **บล็อก regression** — ในโหมด `apply` เน้นกฎที่ไม่ผ่านการตรวจสอบหลังแก้ไข
