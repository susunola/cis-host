# CIS Ubuntu Linux 22.04 LTS Ansible Playbook

Automated CIS Benchmark assessment for Ubuntu Linux 22.04 LTS.
...
- `roles/ohbs-ubuntu2204/` — Role with engine + rules

## Engine

Powered by the shared Python 3 CIS engine.
The catalog (`rules.json`) contains CIS Ubuntu Linux 22.04 LTS Benchmark v3.0.0 rules.
