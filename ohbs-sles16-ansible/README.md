# CIS SUSE Linux Enterprise 16 Ansible Playbook

Automated CIS Benchmark assessment for SUSE Linux Enterprise 16.
...
- `roles/ohbs-sles16/` — Role with engine + rules

## Engine

Powered by the shared Python 3 CIS engine.
The catalog (`rules.json`) contains CIS SUSE Linux Enterprise 16 Benchmark v1.0.0 rules.
